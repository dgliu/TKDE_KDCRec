...
def mf(matrix_train, matrix_valid, embeded_matrix=np.empty(0), matrix_utrain=None,
    ...
    model = MF(m, n, rank, batch_size, lamb=lam, learning_rate=learning_rate, optimizer=Regularizer[optimizer],
               gpu_on=gpu_on)
