...
def main(args):
    ...
    if args.source:
        ...
        np.save('latent/pretrain/{2}/{3}_V_{0}_{1}_{4}'.format(df['model'], df['rank'], args.problem, args.source, args.scene), Y)
        if yBias is not None:
            np.save('latent/pretrain/{2}/{3}_vB_{0}_{1}_{4}'.format(df['model'], df['rank'], args.problem, args.source, args.scene), yBias)
        if X is not None:
        ...
        if xBias is not None:
            np.save('latent/pretrain/{2}/{3}_uB_{0}_{1}_{4}'.format(df['model'], df['rank'], args.problem, args.source, args.scene), xBias)
    else:
        ...
        if yBias is not None:
            np.save('latent/pretrain/{2}/vB_{0}_{1}_{3}'.format(df['model'], df['rank'], args.problem, args.scene), yBias)
        if X is not None:
            np.save('latent/pretrain/{2}/X_{0}_{1}_{3}'.format(df['model'], df['rank'], args.problem, args.scene), X)
        if xBias is not None:
            np.save('latent/pretrain/{2}/uB_{0}_{1}_{3}'.format(df['model'], df['rank'], args.problem, args.scene), xBias)
